...
- imagePrompt: a FLUX text-to-image prompt. MUST have a clear, identifiable foreground subject and a soft/simple background. Incorporate product.imageStyle if provided. Avoid flat silhouettes, ultra-busy scenes, and cluttered compositions. Be specific about lighting, mood, and visual style.
